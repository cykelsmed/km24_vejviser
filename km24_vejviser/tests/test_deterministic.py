...
from km24_vejviser.models.usecase_response import (
    UseCaseResponse, Step, ModuleRef, Overview, Scope, Monitoring,
    HitBudget, Notifications, ParallelProfile, CrossRef, SyntaxGuide,
    Quality, Artifacts
)
            ...
            UseCaseResponse(
                ...
                steps=[
                    Step(
                        ...
                        title="Step 1",
                        type="search",
                        module=ModuleRef(id="test1", name="Test Module 1", is_web_source=False),
                    ...
                    Step(
                        ...
                        type="search",
                        module=ModuleRef(id="test2", name="Test Module 2", is_web_source=False),
